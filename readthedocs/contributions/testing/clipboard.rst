...
logger.debug('Pushing image file to clipboard.\nTry pasting the contents of the clipboard into a folder.\nThat should create a new image file with your image in it.')
